import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./index-DURGLf5P.js";import{a as X,c as t,r as w,f as j,e as m}from"./tokens-DJqrrynb.js";import{u as G}from"./useHover-D0oxY1V2.js";import{W as J}from"./Wordmark-oDhwo-tf.js";import"./_commonjsHelpers-CqkleIqs.js";const h=320;function U({open:e,onClose:a,links:o,contactHref:l,id:n}){const d=p.useRef(null),u=p.useRef(null);p.useEffect(()=>{if(!e)return;const i=s=>{s.key==="Escape"&&a()};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[e,a]),p.useEffect(()=>{var s;if(!e)return;(s=d.current)==null||s.focus();const i=c=>{var T;if(c.key!=="Tab")return;const b=(T=u.current)==null?void 0:T.querySelectorAll("a[href], button");if(!b||b.length===0)return;const N=b[0],C=b[b.length-1];c.shiftKey&&document.activeElement===N?(c.preventDefault(),C.focus()):!c.shiftKey&&document.activeElement===C&&(c.preventDefault(),N.focus())};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[e]),p.useEffect(()=>{if(!e)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[e]);const g={position:"fixed",inset:0,background:"rgba(22,33,31,.5)",opacity:e?1:0,visibility:e?"visible":"hidden",transition:e?`opacity ${h}ms ease, visibility 0s`:`opacity ${h}ms ease, visibility 0s linear ${h}ms`,zIndex:40},F={position:"fixed",top:0,right:0,bottom:0,width:"min(80vw, 320px)",background:t.pine,boxShadow:X.lg,transform:e?"translateX(0)":"translateX(100%)",visibility:e?"visible":"hidden",transition:e?`transform ${h}ms cubic-bezier(.4,0,.2,1), visibility 0s`:`transform ${h}ms cubic-bezier(.4,0,.2,1), visibility 0s linear ${h}ms`,zIndex:41,display:"flex",flexDirection:"column",padding:"18px 24px 32px",overflowY:"auto"};return r.jsxs(r.Fragment,{children:[r.jsx("div",{style:g,onClick:a,"aria-hidden":"true",className:"sc-mobile-menu-backdrop"}),r.jsxs("div",{ref:u,id:n,style:F,role:"dialog","aria-modal":"true","aria-label":"Site menu","aria-hidden":!e,className:"sc-mobile-menu",children:[r.jsx("button",{ref:d,onClick:a,"aria-label":"Close menu",style:{alignSelf:"flex-end",width:40,height:40,borderRadius:w.sm,background:"none",border:"none",color:t.paper,fontSize:26,lineHeight:1,cursor:"pointer",marginBottom:16},children:"×"}),r.jsx("nav",{style:{display:"flex",flexDirection:"column",gap:4},children:o.map(i=>r.jsx("a",{href:i.href,style:{fontFamily:j.display,fontWeight:400,fontSize:24,color:t.paper,textDecoration:"none",padding:"12px 0"},children:i.label},i.label))}),l?r.jsx("a",{href:l,style:{marginTop:24,fontFamily:j.ui,fontWeight:600,fontSize:15,background:t.lime,color:t.ink,padding:"14px 22px",borderRadius:w.pill,textDecoration:"none",textAlign:"center"},children:"Contact"}):null]}),r.jsx("style",{children:`
...
offscreen leaves focusable links sitting outside the viewport.`,methods:[],displayName:"MobileMenu",props:{open:{required:!0,tsType:{name:"boolean"},description:"Whether the drawer is showing."},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the visitor dismisses the drawer (close button, backdrop, or Escape)."},links:{required:!0,tsType:{name:"Array",elements:[{name:"MobileMenuLink"}],raw:"MobileMenuLink[]"},description:"Navigation links to list in the drawer."},contactHref:{required:!1,tsType:{name:"string"},description:"Destination for the Contact call to action. Omitted renders no CTA."},id:{required:!1,tsType:{name:"string"},description:"Ties the drawer to the toggle that controls it (`aria-controls`)."}}};const Q=[{label:"About",href:"#nav"},{label:"Our Work",href:"#nav"},{label:"Newsletter",href:"#nav"}],Z=[{label:"About",href:"#nav"},{label:"Our Work",href:"#nav"}];function ee({label:e,href:a,tone:o}){const{isHovered:l,hoverProps:n}=G(),d=o==="dark",u={fontFamily:j.ui,fontWeight:500,fontSize:15,color:d?t.paper:t.ink,textDecoration:"none",borderBottom:"2px solid transparent",paddingBottom:3,transition:`border-color .3s ${m.out}, color .3s ${m.out}`};return r.jsx("a",{href:a,...n,style:{...u,...l?{borderColor:d?t.lime:t.gold}:{}},children:e})}function re({href:e}){const{isHovered:a,hoverProps:o}=G(),n={...{fontFamily:j.ui,fontWeight:600,fontSize:14,background:t.pine,color:t.paper,border:"none",padding:"10px 22px",borderRadius:w.pill,cursor:"pointer",transition:`transform .2s ${m.out}`,textDecoration:"none",display:"inline-block"},...a?{transform:"translateY(-2px)"}:{}};return e?r.jsx("a",{href:e,...o,style:n,children:"Contact"}):r.jsx("button",{...o,style:n,children:"Contact"})}function te({href:e}){const a={fontFamily:j.ui,fontWeight:600,fontSize:14,background:t.lime,color:t.ink,border:"none",padding:"10px 22px",borderRadius:w.pill,cursor:"pointer",textDecoration:"none",display:"inline-block"};return e?r.jsx("a",{href:e,style:a,children:"Contact"}):r.jsx("button",{style:a,children:"Contact"})}function ne({open:e,onClick:a,controls:o,tone:l}){const n={display:"block",width:20,height:2,borderRadius:2,background:l==="dark"?t.paper:t.ink,transition:`transform .2s ${m.out}, opacity .2s ${m.out}, background .3s ${m.out}`};return r.jsxs("button",{type:"button",onClick:a,"aria-label":e?"Close menu":"Open menu","aria-expanded":e,"aria-controls":o,className:"sc-navbar-toggle",style:{width:44,height:44,borderRadius:w.sm,border:"none",background:"transparent",cursor:"pointer",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:5,padding:0},children:[r.jsx("span",{style:{...n,transform:e?"translateY(7px) rotate(45deg)":"none"}}),r.jsx("span",{style:{...n,opacity:e?0:1}}),r.jsx("span",{style:{...n,transform:e?"translateY(-7px) rotate(-45deg)":"none"}})]})}function f({tone:e="light",links:a,contactHref:o,homeHref:l,chrome:n="card"}){const d=a??(e==="dark"?Z:Q),[u,g]=p.useState(!1),F=p.useId();p.useEffect(()=>{const s=window.matchMedia("(min-width: 640px)"),c=()=>{s.matches&&g(!1)};return s.addEventListener("change",c),()=>s.removeEventListener("change",c)},[]);const i=n==="flush"?{background:"transparent"}:e==="dark"?{borderRadius:16,overflow:"hidden",background:t.ink,backgroundImage:"repeating-linear-gradient(45deg,#1c2a27 0 12px,#1a2724 12px 24px)"}:{background:t.surface,border:`1px solid ${t.border}`,borderRadius:16,overflow:"hidden"};return r.jsxs("div",{style:i,children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:n==="flush"?"8px 28px":"20px 28px",minHeight:n==="flush"?60:void 0},children:[r.jsx("div",{style:{height:44,display:"flex",alignItems:"center",overflow:"visible"},children:r.jsx(J,{tone:e,href:l,height:n==="flush"?50:34,style:n==="flush"?{transform:"rotate(-4deg) translate(-2px, 32px)",transformOrigin:"left center"}:void 0})}),r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:26},children:[r.jsx("div",{className:"sc-navbar-links",children:d.map(s=>r.jsx(ee,{...s,tone:e},s.label))}),r.jsx("div",{className:"sc-navbar-cta",children:e==="dark"?r.jsx(te,{href:o}):r.jsx(re,{href:o})}),r.jsx(ne,{open:u,onClick:()=>g(s=>!s),controls:F,tone:e})]})]}),r.jsx(U,{id:F,open:u,onClose:()=>g(!1),links:d,contactHref:o}),r.jsx("style",{children:`
        .sc-navbar-links {
          display: none;
          align-items: center;
          gap: 26px;
